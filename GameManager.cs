...
public class GameManager
{
    ...
    public List<Item> itemList = new List<Item>() // 등급 : 일반 -> 명작 -> 레어 -> 전설 (등급 마다 성급 추가 최대 ★x3개) I, II, III, IV, V, VI, VII, VIII, IX, X
    {
        ...
        new Weapon{Name = "한손검 글라디우스(왼쪽)[일반★★]", ItemID = 3, Price = 1000, ItemType = 5, Inform = "폭 넓은 양날 장검 무거워서 신속하게 사용 힘듬, 방패랑 사용하면 안정적이다 왼쪽은 악세서리 착용이 불가능하다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = true, Atk = 1.3f,},

        new Weapon{Name = "레빗 백색 레이피어[명작★]", ItemID = 3, Price = 4200, ItemType = 5, Inform = "정화된 은 과 백철을 1:9 섞어서 제작했다, 레빗이라는 명장이 만든 한손검 레이피어다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = true, Atk = 2.1f,},

        new Weapon{Name = "이름없는 붉은 세이버[명작★★]", ItemID = 3, Price = 5200, ItemType = 5, Inform = "양손을로 사용하는 도 검, 어떤 광물이 들어가 제작되었는지는 모른다 하지만 엄청 예리한 검은 틀림없다.",
        ...
        new Armor{Name = "고블린 찰갑[일반★★]", ItemID = 6, Price = 1900, ItemType = 1, Inform = "고블린 뼈로 만든 미늘 조각에 끈으로 연결하여 만든 갑옷, 꽤나 튼튼하고 유지 보수가 쉽다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = true, Def = 1.5f},

        new Armor{Name = "레빗 백색 플레이트 아머[명작★★]", ItemID = 0, Price = 5000, ItemType = 1, Inform = "백철과 흑철을 5:5 섞어서 제작했다 레빗이라는 명장이 만든 플레이트 아머다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = true, Def = 2.3f,},

        new Armor{Name = "아이언 그리브[일반]", ItemID = 10, Price = 600, ItemType = 3, Inform = "철판으로 만든 그리브, 가죽보다는 튼튼하다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 0.3f},

        new Armor{Name = "백색 그리브[일반★★★]", ItemID = 10, Price = 1800, ItemType = 3, Inform = "강철과 백철을 7:3.섞어서 제작했다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 0.6f},

        new Armor{Name = "레빗 백색 그리브[명작★]", ItemID = 10, Price = 3800, ItemType = 3, Inform = "백철과 흑철을 9:1 섞어서 제작했다 레빗이라는 명장이 만든 그리브다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 1.0f},

        new Armor{Name = "아이언 투구[일반]", ItemID = 11, Price = 800, ItemType = 4, Inform = "철로 만든 투구, 가죽보다는 튼튼하다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 0.5f},

        new Armor{Name = "강철 투구[일반★★]", ItemID = 11, Price = 1000, ItemType = 4, Inform = "강철로 만든 투구, 철보다는 튼튼하다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 0.8f},

        new Armor{Name = "레빗 백색 투구[명작]", ItemID = 11, Price = 3600, ItemType = 4, Inform = "강철과 백철을 5:5 섞어서 제작했다, 레빗이라는 명장이 만든 투구이다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Def = 1.1f},

        new Weapon{Name = "강타 반지[일반★]", ItemID = 12, Price = 1250, ItemType = 5, Inform = "철로만든 반지, 강타 마법룬(I)이 새겨져있다.",
        IsEquiped = false, ShopFlag = true, MonsterFlag = false, Atk = 1.4f},

        new Armor{Name = "방어 반지[일반★]", ItemID = 13, Price = 1300, ItemType = 6, Inform = "철로만든 반지, 보호 마법룬이 새겨져있다.",
        ...
        new Weapon{Name = "고블린 해골[등급: 일반] ", ItemID = 54, Price = 200, ItemType = 5, Inform = "징그러운 고블린 해골 상점에 팔면된다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, ERareFlag = true  ,Atk = 0f},//Easy

        new Weapon{Name = "튜터의 잃어버린 밥그릇[등급: 세트] ", ItemID = 55, Price = 1, ItemType = 5, Inform = "튜터의 밥그릇이다 튜터중 누군가 밥을 못먹고 있는것이 틀림없다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, ERareFlag = true  ,Atk = 0.1f},//Easy

        new Weapon{Name = "튜터의 잃어버린 왼쪽 부츠[등급: 세트] ", ItemID = 56, Price = 1, ItemType = 5, Inform = "어쩌다 잃어버린걸까.. 알수없다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, ERareFlag = true  ,Atk = 0.1f},//Easy

        new Weapon{Name = "은빛늑대 츠바이헨더[등급: 명작★★★] ", ItemID = 57, Price = 7000, ItemType = 0, Inform = "명장이 정화된 은을 첨가하여 만든 대검이다 칼자루 끝에 검은늑대 머리 형상이 있으며 두 눈에 작은 붉은색 루비가 박혀있다 가격은 상당히 비싸다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 4.1f},//Normal

        new Armor{Name = "검은늑대방패[등급: 명작★] ", ItemID = 58, Price = 4000, ItemType = 6, Inform = "본체는 나무이며 검은 청동 철판을 덮은 지름 1미터 원형 방패 방패 중간에 검은늑대 머리가 각인되어 있다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Def = 1.5f},//Normal

        new Weapon{Name = "옥구슬[등급: 일반★] ", ItemID = 59, Price = 850, ItemType = 5, Inform = "품질이 좋아보이는 옥이다 값 비싸게 판매가 가능하다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 0.0f},//Normal

        new Weapon{Name = "부셔진 옥구슬[등급: 일반] ", ItemID = 63, Price = 450, ItemType = 5, Inform = "부셔져 버린 상태는 상품 가치가 낮다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 0.0f},//Normal

        new Armor{Name = "청옥반지[등급: 명작★★] ", ItemID = 59, Price = 4800, ItemType = 5, Inform = "금속으로 만들어졌으며 센터에 희귀한 청옥구슬이 박혀있다, 보호룬(II)이 새겨져있다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Def = 1.8f},//Normal

        new Weapon{Name = "푸바오 목각인형[등급: 일반] ", ItemID = 60, Price = 10, ItemType = 5, Inform = "대상을 그리워하는 마음으로 조각한거 같다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 0.0f},//Normal

        new Armor{Name = "검은 판금 그리브[등급: 명작★★] ", ItemID = 61, Price = 4500, ItemType = 1, Inform = "흑철을 사용해서 만든 그리브 이다. 흑철은 마법의 저항력과 강철보다 높은 내구성을 가지고있다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Def = 1.3f},//Normal

        new Armor{Name = "검은 경번갑 갑옷[등급: 명작★★] ", ItemID = 62, Price = 5200, ItemType = 1, Inform = "사슬 갑옷에 철판을 유기적으로 결합시킨 갑옷이다 재료는 흑철이 들어가서 검은색을 띈다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Def = 2.5f},//Normal

        new Weapon{Name = "튜터의 회고록[등급: 세트] ", ItemID = 64, Price = 10, ItemType = 5, Inform = "누군가의 회고록이다 무슨 내용인지 모르겠다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 0.1f},//Normal

        new Weapon{Name = "튜터의 목검[등급: 세트] ", ItemID = 65, Price = 10, ItemType = 0, Inform = "튜터라는 전사가 쓰던 목검이다 날 부분을 날카롭게 갈았으며 생각보다 튼튼해서 쓸만하다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 2.5f},//Normal

        new Weapon{Name = "EIEI 목걸이[등급: 명작★★★] ", ItemID = 66, Price = 7000, ItemType = 5, Inform = "유명한 길드 이름으로 만든 은목걸이 누구나 가입하고 싶어 하는 길드에서 제작한 진품 목걸이다 강타 마법룬(III)이 새겨져있다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, NRareFlag = true  ,Atk = 3.0f},//Normal

        new Weapon{Name = "냉창 란세어[등급: 레어★] ", ItemID = 67, Price = 8900, ItemType = 0, Inform = "냉기를 뿜는 냉철을 사용해서 제작했다, 생긴 모양은 양옆 블레이드가 크고 갈고리처럼 휘어있으며 창 중앙에 길고 뾰족한 50cm 창날이 있다 이 창에 맞은 부위는 얼어서 괴사한다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, HRareFlag = true  ,Atk = 4.9f},//Hard

        new Armor{Name = "천산 어린갑[등급: 레어★★] ", ItemID = 68, Price = 11000, ItemType =1, Inform = "천산갑이라는 동물의 비늘을 겹겹이 쌓아서 안감과 연결해서 만들었다 천산갑의 비늘은 상당히 고가이며 내구성이 미스릴 보다 높아 부르는 게 값이다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, HRareFlag = true  ,Def = 4.6f},//Hard

        new Weapon{Name = "역전의 마티네 목걸이[등급: 레어★★★] ", ItemID = 69, Price =5, ItemType = 6, Inform = "황금빛으로 빛나는 정교한 체인이 목을 감싸고, 그 중심에는 전설의 금속 오리하르콘으로 세공된 작은 쌍검이 십자 형태로 교차하며 장식되어 있다. 강타 마법룬IV이 새겨져있다. ",
        IsEquiped = false, ShopFlag = false, MonsterFlag = false, HRareFlag = true  ,Atk = 4.5f},//Hard

        new Weapon{Name = "붉은루비[등급: 일반★★★] ", ItemID = 70, Price = 1500, ItemType =5, Inform = "붉은 빛이 매혹적이다 값 비싸게 판매가 가능하다. ",
